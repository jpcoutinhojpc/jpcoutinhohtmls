...
3. Ajuste a largura máxima do GC e defina o **limite de texto** em pixels; se o texto passar do limite, ele é comprimido automaticamente sem quebrar linha.
4. Clique em **Mostrar GC** para exibir a arte com animação; use **Ocultar GC** para esconder.
